...
def niveles():
    ...
    btn1 = pygame.Rect(600, 150, 200, 50)
    btn2 = pygame.Rect(600, 230, 200, 50)
    btn3 = pygame.Rect(600, 300, 200, 50)
    btn4 = pygame.Rect(600, 370, 200, 50)
    ...
    while isRunning:
        ...
        pygame.draw.rect(screen, (255, 242, 0), btn4)

        escribir('Nivel 1', 25, (0, 0, 0), screen, 660, 155)
        escribir('Nivel 2', 25, (0, 0, 0), screen, 660, 235)
        escribir('Nivel 3', 25, (0, 0, 0), screen, 660, 305)
        escribir('Manual', 25, (0, 0, 0),screen, 660, 375)

        mx, my = pygame.mouse.get_pos()

        if btn1.collidepoint((mx, my)):
            pygame.draw.rect(screen, (255, 128, 128), btn1)
            escribir('Nivel 1', 25, (255, 255, 255), screen,  660, 155)
            if click:
                Jugar(1)
                screen.fill((0, 0, 0))
            ...
            escribir('Nivel 2', 25, (255, 255, 255), screen,  660, 235)
            if click:
                Jugar(2)
        elif btn3.collidepoint((mx, my)):
            pygame.draw.rect(screen, (255, 128, 128), btn3)
            escribir('Nivel 3', 25, (255, 255, 255), screen, 660, 305)
            if click:
                Jugar(3)

        if btn4.collidepoint((mx, my)):
            pygame.draw.rect(screen, (255, 128, 128), btn4)
            escribir('Manual', 25, (255, 255, 255), screen, 660, 375)
            if click:
                fondoBikini = pygame.image.load('imagenes/fondo.jpg')
                fondoBikini = pygame.transform.rotozoom(fondoBikini, 0, 1.2)
                fondo = fondoBikini.get_rect()
